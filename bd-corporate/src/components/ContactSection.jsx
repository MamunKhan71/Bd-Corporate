...
const ContactSection = () => {
    return (
        <div className="container mx-auto flex flex-col lg:flex-row space-y-4 lg:space-y-0 items-center justify-around bg-[#F7F7F7] p-12">
            <div className="text-center lg:text-left">
                <h1 className="text-3xl font-bold text-primary">Need help? Talk to our expert.</h1>
                <p className="text-gray-500 font-medium text-center">Talk to our experts or Browse through more properties.</p>
            </div>
