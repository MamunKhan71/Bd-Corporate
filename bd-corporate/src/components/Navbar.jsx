                        ...
                        !user ? <>
                            {
                                location === '/login' ? <><Link
                                    to="/register"
                                    className="px-5 py-1 lg:py-2.5 overflow-hidden group bg-primary relative hover:bg-gradient-to-r hover:from-black hover:to-primary text-white hover:ring-2 hover:ring-offset-2 hover:ring-primary transition-all ease-out duration-300"
                                >
