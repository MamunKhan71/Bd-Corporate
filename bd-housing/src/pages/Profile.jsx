    ...
    return (
        <div className="w-full flex justify-center items-center h-screen">
            <div className="p-12 shadow-md sm:px-12 text-primary space-y-4">
                <img src="https://source.unsplash.com/150x150/?portrait?3" alt="" className="w-32 h-32 mx-auto rounded-full aspect-square" />
                <div className="space-y-4 text-center divide-y divide-gray-700 text-primary">
                    ...
                    <div className="flex justify-center pt-2 space-x-4 align-center">
                        <a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md text-primary hover:text-violet-400">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md text-primary hover:text-violet-400">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md text-primary hover:text-violet-400">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md text-primary hover:text-violet-400">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                ...
                <button onClick={logout} className="w-full flex items-center justify-center">
