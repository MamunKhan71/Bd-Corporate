                    ...
                    <div className="space-y-7 flex items-center flex-col w-full">
                        ...
                        <form onSubmit={handleSubmit(handleCreateUser)} className="space-y-4 w-full">
                            <div className="mb-8 flex flex-col gap-4">
                                <div className="w-full">
                                    <input {...register('name')} type="text" placeholder="Your name here" className="input bg-[#F5F9FE] w-full p-7" />
                                </div>
                                <div className="w-full">
                                    <input {...register('email')} type="email" placeholder="Your email here" className="input bg-[#F5F9FE] w-full p-7" />
                                </div>
                                <div className="w-full">
                                    <input {...register('photoUrl')} type="text" placeholder="Your photo url here" className="input bg-[#F5F9FE] w-full p-7" />
                                </div>
                            ...
                            <div className="w-full">
                                <button type="submit" className="hover:cursor-pointer w-full relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-primary text-white rounded hover:bg-primary group">
