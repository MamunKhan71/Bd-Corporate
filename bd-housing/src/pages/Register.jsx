                    ...
                    <div className="space-y-7 flex items-center flex-col w-full">
                        ...
                        <div className="space-y-4 w-full">
                            <div className="mb-8 flex flex-col gap-4">
                                <div className="w-full">
                                    <input type="text" placeholder="Your name here" className="input bg-[#F5F9FE] w-full p-7" />
                                </div>
                                <div className="w-full">
                                    <input type="email" placeholder="Your email here" className="input bg-[#F5F9FE] w-full p-7" />
                                </div>
                                <div className="w-full">
                                    <input type="text" placeholder="Your photo url here" className="input bg-[#F5F9FE] w-full p-7" />
                                </div>
                                <div className="w-full space-y-2">
                                    <label className="input flex items-center gap-2 bg-[#F5F9FE] p-7">
                                        <input type="password" className="grow w-full" placeholder="••••••••" />
