        ...
        <div className="grid grid-cols-2">
            ...
            <div className="bg-[#eb675314] flex items-center justify-center flex-col">
                <div className="space-y-8">
                    ...
                    <div className="w-1/2">
                        <a className="hover:cursor-pointer w-full relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-primary text-white hover:bg-primary group">
